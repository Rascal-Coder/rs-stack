...
import { DecorIcon } from "@rs-stack/ui/components/decor-icon";
  ...
  return (
    <section className="mb-32 overflow-x-clip p-4">
      <div className="relative container mx-auto flex flex-col justify-between gap-y-4 border-y px-4 py-8 lg:max-w-4xl">
        ...
        <h2 className="font-display relative z-10 text-center text-4xl sm:text-5xl">
          {m.home_page__cta_title()}
        </h2>
        <p className="relative z-10 text-center text-sm text-balance text-muted-foreground md:text-base">
